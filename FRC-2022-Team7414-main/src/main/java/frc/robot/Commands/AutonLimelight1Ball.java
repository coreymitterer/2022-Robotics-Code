...
public class AutonLimelight1Ball extends AutonBase {
    private int flag = 0;
    private double time;
    ...
    public AutonLimelight1Ball(double pow) {
        super(pow);
        finished = false;
    ...
    public void execute(){
        ...
        }if(flag ==2){ //spin up(already done)
            Robot.shooter.PIDShooter(2200);
